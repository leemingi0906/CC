...
class Crowd(data.Dataset):
    def __init__(self, root_path, crop_size,
        ...
        self.use_npoint = (self.alpha > 0.0) and (method == 'train') and (apply_npoint is not None)
    ...
    def __getitem__(self, item):
        ...
        if self.use_npoint and len(keypoints) > 0:
            wd, ht = img.size
            keypoints = apply_npoint(keypoints, (ht, wd), alpha=self.alpha, k=6)
