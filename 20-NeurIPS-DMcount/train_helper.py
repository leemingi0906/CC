...
class Trainer(object):
    ...
    def setup(self):
        ...
        # NPoint 실험 폴더명 구분
        if args.use_npoint:
             sub_dir += f'_NPoint_a{args.alpha}_ad{args.adaptive_npoint}'
        ...
        # 데이터셋 초기화 시 NPoint 인자 전달
        # datasets/crowd.py의 __init__ 메서드 시그니처에 맞춰야 함
        if args.dataset.lower() == 'qnrf':
            ...
            # [수정] Crowd_sh 초기화 시 NPoint 인자 전달
            self.datasets = {
                ...
                'val': Crowd_sh(os.path.join(args.data_dir, 'test_data'),
                                ...
                                use_npoint=False) # Validation에는 NPoint 적용 안 함
            }
        else:
